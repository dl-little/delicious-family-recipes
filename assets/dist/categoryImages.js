document.addEventListener( "DOMContentLoaded", function(e) {
	...
	let frame,
		...
		catSlug        = document.getElementById('dfr_image_field').getAttribute('data-slug');
	...
	addImageLink.addEventListener('click', function(e) {
		...
		frame.on('select', function() {
			...
			const attachmentSizeUrl  = attachment.sizes.thumbnail ? attachment.sizes.thumbnail.url : attachment.url;
